...
libraryDependencies ++= Seq(
  ...
  "org.apache.solr"       %  "solr-core" % "6.4.1" % "test" excludeAll(ExclusionRule(organization = "org.restlet.jee"))
)

unmanagedJars in Compile += file("libs/org.restlet.ext.servlet-2.3.0.jar")
unmanagedJars in Compile += file("lib/org.restlet-2.3.0.jar")